...
namespace pr1_4
{
    internal class Program
    {
        ...
        {
            // Просим пользователя вввести начало и конец диапазона, в рамках которого будет заполняться массив
            ...
            // используя foreach выводи элемента массива в одну строку с пробелом между ними
        ...
        {            
            ...
            int n = rnd.Next(5, 20); 
            // Размер массива определяется рандомным числом в диапазоне 5-20
            
            int[] numbers = new int[n]; // Создаем массив numbers
            
            Console.WriteLine($"Массив с числами в диапазоне {start} - {finish}:");            
            // Заполняем numbers случайными числами при помощи цикла for
            for (int i = 0; i < n; i++)
            {
